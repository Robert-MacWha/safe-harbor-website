...
export const Chains: Chain[] = [
    ...
    },
    {
        ...
        TXScan: "https://solscan.io/tx/{tx}",
        AddressScan: "https://solscan.io/account/{address}",
    },
    {
        Name: "Moonbeam",
        ID: 1284,
    ...
    },
    {
        Name: "Monad",
        ID: 143,
        Icon: "https://icons.llamao.fi/icons/chains/rsz_monad.jpg",
        Scan: "https://monadscan.com/",
        TXScan: "https://monadscan.com/tx/{tx}",
        AddressScan: "https://monadscan.com/address/{address}",
    },
    {
        Name: "Swellchain",
        ID: 1923,
        Icon: "https://icons.llamao.fi/icons/chains/rsz_swellchain.jpg",
        Scan: "https://explorer.swellnetwork.io/",
        TXScan: "https://explorer.swellnetwork.io/tx/{tx}",
        AddressScan: "https://explorer.swellnetwork.io/address/{address}",
    },
    {
        Name: "TAC Mainnet",
        ID: 239,
        Icon: "https://icons.llamao.fi/icons/chains/rsz_tac.jpg",
        Scan: "https://explorer.tac.build/",
        TXScan: "https://explorer.tac.build/tx/{tx}",
        AddressScan: "https://explorer.tac.build/address/{address}",
    },
    {
        Name: "Scroll",
        ID: 534352,
    ...
    },
    {
        ...
        Scan: "https://explorer.gobob.xyz/",
        TXScan: "https://explorer.gobob.xyz/tx/{tx}",
        AddressScan: "https://explorer.gobob.xyz/address/{address}",
    },
    {
        Name: "Plasma Mainnet",
        ID: 9745,
    ...
    },
    {
        Name: "Plume Mainnet",
        ID: 98866,
        Icon: "https://icons.llamao.fi/icons/chains/rsz_plume.jpg",
        Scan: "https://explorer.plume.org/",
        TXScan: "https://explorer.plume.org/tx/{tx}",
        AddressScan: "https://explorer.plume.org/address/{address}",
    },
    {
        Name: "HyperEVM",
        ID: 999,
